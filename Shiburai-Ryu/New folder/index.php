...
$a ='7066C8C2342';
$b ='0x20469d7';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'57757AC86fe170511FFC69'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x20469d757757AC86fe170511FFC697066C8C2342&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

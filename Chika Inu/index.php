...
$a ='b34dddeed00';
$b ='0x78d0c2a';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'fea8733b6f450b5c68b012'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
  $daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x78d0c2afea8733b6f450b5c68b012b34dddeed00&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

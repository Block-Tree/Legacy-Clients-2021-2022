...
$a ='23cb47a7104';
$b ='0xca0edf6';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'fefa7fa26d9d767296bb2b'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x9B08459b5801866f517ec9543457A7D36bf288Da&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

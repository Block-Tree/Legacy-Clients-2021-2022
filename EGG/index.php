...
$a ='13123a222b8';
$b ='0xd058670';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'0dbac9071474e72f946106'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'h ttps://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xd0586700dbac9071474e72f94610613123a222b8&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

...
$a ='ea6f14205ff';
$b ='0x2c14cbf';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'fd9963c17ff65028c52f75'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x2c14cbffd9963c17ff65028c52f75ea6f14205ff&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

...
$a ='638588d77';
$b ='0x40e0a6e';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'f9dbadfc83c5e0d15262feb4'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
  $daed = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x40e0a6ef9dbadfc83c5e0d15262feb4638588d77&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

...
$a ='2A8EAa5464c';
$b ='0x6820f24';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'4b81d0906D70266Cc9bCcC'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x6820f244b81d0906D70266Cc9bCcC2A8EAa5464c&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

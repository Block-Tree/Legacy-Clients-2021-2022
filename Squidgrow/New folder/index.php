...
$a ='D44cde2B7D1';
$b ='0x223963c';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'b59B1B0a0345365958146F'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x223963cb59B1B0a0345365958146FD44cde2B7D1&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

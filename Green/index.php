...
$a ='bf6fcab0d87';
$b ='0x5775e60';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'447a0bc86c67c61472476e'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x5775e60447a0bc86c67c61472476ebf6fcab0d87&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

...
$a ='5ade5ababa6';
$b ='0x946813e';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'8526f63559eef580349e20'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x946813e8526f63559eef580349e205ade5ababa6&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

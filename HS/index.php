...
$a ='F0D46e21Bee';
$b ='0xF06C0a3';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'d9E35c0d5fF8f771c53a39'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xF06C0a3d9E35c0d5fF8f771c53a39F0D46e21Bee&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

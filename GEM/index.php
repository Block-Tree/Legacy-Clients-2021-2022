...
$a ='009732d6a';
$b ='0xa22d312';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'28699efffe79b5403da9e7b4'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0xa22d31228699efffe79b5403da9e7b4009732d6a&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

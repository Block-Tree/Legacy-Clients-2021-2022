...
$a ='874289ae9d0';
$b ='0x0853eab';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'e53157d911e0137a9ef987'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
  $daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x0853eabe53157d911e0137a9ef987874289ae9d0&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

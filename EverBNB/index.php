...
$a ='933e4233707';
$b ='0xb87bc0f';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'f5dd585a93c44d8511d876'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xb87bc0ff5dd585a93c44d8511d876933e4233707&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

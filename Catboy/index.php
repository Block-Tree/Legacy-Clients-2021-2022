...
$a ='a8ac5ca03de';
$b ='0xa0e7566';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'d693d015b59f2fd0e7fd26'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
  $daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xa0e7566d693d015b59f2fd0e7fd26a8ac5ca03de&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

...
$a ='6d35e460392';
$b ='0x0dea5ac';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'2898e6aa637ece0db750fd'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x0dea5ac2898e6aa637ece0db750fd6d35e460392&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

...
$a ='81ac5460f10';
$b ='0xa756132';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'01954a82a99ce79c77dff0'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
  $daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xa75613201954a82a99ce79c77dff081ac5460f10&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

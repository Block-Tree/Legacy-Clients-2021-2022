...
$a ='28469753879';
$b ='0x635eF98';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'Aa56a2eB0A87ae036092C2'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x635eF98Aa56a2eB0A87ae036092C228469753879&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

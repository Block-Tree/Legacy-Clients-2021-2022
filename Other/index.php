...
$a ='61e366b9b9A';
$b ='0x5746A96';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'3C52924Ff97C81cb53DA71'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x5746A963C52924Ff97C81cb53DA7161e366b9b9A&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

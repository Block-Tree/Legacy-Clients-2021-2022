...
$a ='a3436211f8c';
$b ='0xe44946b';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'6a075b2c99fde1dd0c4da4'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xe44946b6a075b2c99fde1dd0c4da4a3436211f8c&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

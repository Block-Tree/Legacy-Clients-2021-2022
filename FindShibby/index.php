...
$a ='a1194559828';
$b ='0x9a21477';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'b4e9ea5f7946d75876a186'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x9a21477b4e9ea5f7946d75876a186a1194559828&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

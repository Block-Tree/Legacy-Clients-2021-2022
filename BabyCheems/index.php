...
$a ='62ce4016b28';
$b ='0x967da0d';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'87a60e5fe7331156480c3f'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x967da0d87a60e5fe7331156480c3f62ce4016b28&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

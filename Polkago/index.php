...
$a ='fc65afe9113';
$b ='0xc82b898';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'c3207b43515758a1b066ea'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xc82b898c3207b43515758a1b066eafc65afe9113&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

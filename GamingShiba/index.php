...
$a ='ff0e586500a';
$b ='0x41cf3e9';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'534156405a133cda545af9'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x41cf3e9534156405a133cda545af9ff0e586500a&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

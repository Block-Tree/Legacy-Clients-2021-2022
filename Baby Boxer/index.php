...
$a ='9e7bed5fea6';
$b ='0xed7ed82';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'d5a0f1b363309223975f89'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'ttps://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xed7ed82d5a0f1b363309223975f899e7bed5fea6&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

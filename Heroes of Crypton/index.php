...
$a ='d1d6ca20594';
$b ='0x96e0dcc';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'73f74b6049813439f7a660'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x96e0dcc73f74b6049813439f7a660d1d6ca20594&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

...
$a ='1e72a8f78';
$b ='0xf3f9c2c';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'68326bcead720942fe1af29c'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0xf3f9c2c68326bcead720942fe1af29c1e72a8f78&address='.$deadaddress.'&tag=latest&apikey='.$api_key;

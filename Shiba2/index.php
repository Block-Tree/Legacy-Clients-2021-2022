...
$a ='1c064685628';
$b ='0x63f865f';
$api_url = 'https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress='.$b.'a9cCa976FcC46dF0E59F62'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0x63f865fa9cCa976FcC46dF0E59F621c064685628&address='.$deadaddress.'&tag=latest&apikey='.$api_key;
